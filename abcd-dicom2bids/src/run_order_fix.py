...
def _cli():
    ...
    if args.generate_map:
        ...
        get_bids_errors_correction_map(input_json, output_map, bids_input, session)
...
def generate_parser():
    ...
    parser.add_argument(
        ...
        help='optional subject list to narrow down bids inputs. ONLY USED '
             'DURING GET BIDS ERRORS CORRECTION MAP'
    )
    parser.add_argument(
...
def get_bids_errors_correction_map(input_json,  output_map, bids_input=None, session=None):
